...
* **connect function**:This function creates a connection to the server using a conection ID, allowing you to send and receive real-time notifications between the client and server.

  ```ruby
  notifications.connect(connectionId);
  ```
