...
(http://localhost:5000/liveNotifications) with the **target**(which in this case is the socketID/room I want to emit the notification to) and **message**(which is the content of the notification I want to send)the notification will be emitted and the clients can hear the notification(I will explain with more detail how the client part will work and how he will the hear for the notifications down bellow).
